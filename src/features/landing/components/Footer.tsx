import { ExternalLink, Globe, Send, Share2 } from 'lucide-react'
...
const BOTTOM_LINKS = ['Privacidad', 'Términos', 'Cookies']
              ...
              {SOCIAL_LINKS.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="flex size-9 items-center justify-center rounded-full bg-white/5 text-muted-foreground transition-colors hover:bg-primary/15 hover:text-primary"
                  >
          ...
          <ul className="flex flex-wrap gap-x-5 gap-y-2.5">
            {BOTTOM_LINKS.map((label) => (
              <li key={label}>
                <a
                  href="#"
                  className="font-mono text-xs tracking-[0.25em] text-muted-foreground uppercase transition-colors hover:text-primary"
                >
                  {label}
                </a>
              </li>
